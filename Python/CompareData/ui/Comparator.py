...
from ui import FileFormatter, FileContent, InfoDialog
from utils import Dialogs, Files, Constant


# Form implementation generated from reading ui file 'd:\Dev Pros\toolbox\Python\CompareData\ui\Comparator.ui'
#
...
class Ui_MainWindow(object):
    def __init__(self):
        self.del_fields_file = None

    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(944, 670)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("d:\\Dev Pros\\toolbox\\Python\\CompareData\\ui\\../icon/ybj.png"),
        ...
        self.label_tip_1 = QtWidgets.QLabel(self.verticalLayout_1)
        self.label_tip_1.setObjectName("label_tip_1")
        self.verticalLayout_2.addWidget(self.label_tip_1)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("d:\\Dev Pros\\toolbox\\Python\\CompareData\\ui\\../icon/plat.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("d:\\Dev Pros\\toolbox\\Python\\CompareData\\ui\\../icon/his.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("d:\\Dev Pros\\toolbox\\Python\\CompareData\\ui\\../icon/excel2.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_tip_2 = QtWidgets.QLabel(self.verticalLayout_1)
        self.label_tip_2.setObjectName("label_tip_2")
        self.verticalLayout_4.addWidget(self.label_tip_2)
        ...
        self.label_5 = QtWidgets.QLabel(self.verticalLayout_1)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_tip_3 = QtWidgets.QLabel(self.verticalLayout_1)
        self.label_tip_3.setObjectName("label_tip_3")
        self.verticalLayout_6.addWidget(self.label_tip_3)
        self.del_fields_template_btn = QtWidgets.QPushButton(self.verticalLayout_1)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.del_fields_template_btn.setFont(font)
        self.del_fields_template_btn.setIcon(icon3)
        self.del_fields_template_btn.setObjectName("del_fields_template_btn")
        self.verticalLayout_6.addWidget(self.del_fields_template_btn)
        self.v_2.addLayout(self.verticalLayout_6)
        ...
        self.label_tip_4 = QtWidgets.QLabel(self.verticalLayout_1)
        self.label_tip_4.setObjectName("label_tip_4")
        self.verticalLayout_3.addWidget(self.label_tip_4)
        ...
        self.label_tip_5 = QtWidgets.QLabel(self.verticalLayout_1)
        self.label_tip_5.setObjectName("label_tip_5")
        self.verticalLayout_5.addWidget(self.label_tip_5)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("d:\\Dev Pros\\toolbox\\Python\\CompareData\\ui\\../icon/execute.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("d:\\Dev Pros\\toolbox\\Python\\CompareData\\ui\\../icon/excel.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_file_formatter.setIcon(icon5)
        self.action_file_formatter.setObjectName("action_file_formatter")
        self.action_about = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("d:\\Dev Pros\\toolbox\\Python\\CompareData\\ui\\../icon/about.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_about.setIcon(icon6)
        self.action_about.setObjectName("action_about")
        self.actionaction_file_content = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("d:\\Dev Pros\\toolbox\\Python\\CompareData\\ui\\../icon/content.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.del_fields_template_btn.clicked.connect(self.del_fields_template_trigger)
    ...
    def plat_file_clicked(self):
        ...
        self.open_plat_thread.success.connect(lambda: Dialogs.info("已经成功从本地上传招采文件。\n\n请继续下一步操作。"))
    ...
    def his_file_clicked(self):
        ...
        self.open_his_thread.success.connect(lambda: Dialogs.info("已经成功从本地上传 HIS 文件。\n\n请继续下一步操作。"))
    ...
    def execute_signal(self, output_path):
        ...
        Dialogs.menu(f'制作完成。\n\n你可以打开文件，或打开文件夹，或关闭对话框。', lambda: os.startfile(self.output_path),
                     lambda: os.startfile(Files.get_folder(self.output_path)))
    ...
    def execute_clicked(self):
        ...
        self.execute_thread.set_values(df, plat_key, his_key, self.plat_file, self.his_file, self.del_fields_file,
                                       filename)
    ...
    def del_fields_template_trigger(self):
        self.del_fields_file = Files.openfile()
        self.del_fields_thread = CompartorService.GetFileDataThread()
        self.del_fields_thread.set_values(self.del_fields_file)
        self.del_fields_thread.success.connect(
            lambda: Dialogs.info("已经成功从本地上删除字段模板采文件。\n\n请继续下一步操作。"))
        self.del_fields_thread.error.connect(Dialogs.error)
        self.del_fields_thread.start()

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "吐鲁番市药品医用耗材网采率小程序 - V2.4.4"))
        self.label_1.setText(_translate("MainWindow", "文件上传区域"))
        self.label_tip_1.setText(_translate("MainWindow",
                                            "上传三个必要文件，入库汇总、HIS 入库、药品或耗材模板文件。若有不懂请联系市医保局工程师协助。"))
        ...
        self.label_3.setText(_translate("MainWindow", "模板文件内容预览"))
        self.label_tip_2.setText(_translate("MainWindow",
                                            "模板文件上传成功之后下面会显示模板文件的内容，若有修改请直接修改模板文件本身，不在该区域下修改。模板文件有复杂的公式需要填写，建议联系市医保局工程师协助。"))
        ...
        self.label_5.setText(_translate("MainWindow", "字段删除模板文件"))
        self.label_tip_3.setText(_translate("MainWindow",
                                            "如果每次产生的对比表中都有你不想要的药品或耗材，请上传该文件排除不要的数据。若你没有这个需求，忽略该过程，请进行下一步。"))
        self.del_fields_template_btn.setText(_translate("MainWindow", "上传字段删除模板文件"))
        self.label_2.setText(_translate("MainWindow", "对比表连接关键字"))
        self.label_tip_4.setText(
            _translate("MainWindow", "该操作的意思是招采入库汇总和HIS入库汇总通过什么字段进行相连，通常选择医保编码。"))
        self.plat_key_label.setText(_translate("MainWindow", "招采关键字"))
        self.his_key_label.setText(_translate("MainWindow", "HIS 关键字"))
        self.label_4.setText(_translate("MainWindow", "文件输出配置"))
        self.label_tip_5.setText(
            _translate("MainWindow", "文件输出位置在你招采入库汇总文件所在位置，或可以直接通过对话框打开文件预览。"))
        self.output_filename_label.setText(_translate("MainWindow", "文件名"))
        self.execute_btn.setText(_translate("MainWindow", "开始制作文件"))
        self.menu_1.setTitle(_translate("MainWindow", "小工具集"))
